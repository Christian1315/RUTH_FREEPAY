            ...
            <div class="col-md-12">
                <nav class="navbar navbar-expand-lg">
                    <div class="container-fluid">
                        <a class="navbar-brand text-white bg-dark px-3" href="/"> <strong>FREEPAY</strong></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <form class="d-flex" role="search">
                                <img src="logo_freepay.png" class="shadow-lg p-3 bg-body rounded" alt="" srcset="">
                            </form>
                        </div>
                    </div>
                </nav>
    ...
    <div class="container content">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1 class="title">Soyez les bienvenus sur l'API de FREEPAY</h1>
